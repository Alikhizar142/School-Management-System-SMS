...
if (
  ...
  if ($_SESSION['role'] == 'Admin') {
    ...
    <body class="admin-bg" class="black-fill">
      <?php
        ...
        <div class="container text-center">
          <div class="row row-cols-5">
            <a href="teacher.php" class="col btn btn-dark m-2 py-3">
              <i class="fa fa-chalkboard-teacher fs-1" aria-hidden="true"></i><br>
              Teachers
            </a>
            ...
            <a href="class_wise_student.php" class="col btn btn-dark m-2 py-3">
              <i class="fa fa-cubes fs-1" aria-hidden="true"></i><br>
              Classwise Students
            </a>
            <a href="../logout.php" class="col btn btn-warning m-2 py-3 col-5">
              <i class="fa fa-sign-out-alt fs-1" aria-hidden="true"></i><br>
              Logout
            </a>
          </div>
        </div>
